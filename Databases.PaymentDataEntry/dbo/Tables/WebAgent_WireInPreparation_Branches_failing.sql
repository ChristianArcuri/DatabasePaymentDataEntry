CREATE TABLE [dbo].[WebAgent_WireInPreparation_Branches_failing] (
    ...
    CONSTRAINT [PK_WebAgent_WireInPreparation_Branches_1] PRIMARY KEY CLUSTERED ([RecordId] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_WebAgent_WireInPreparation_Branches_PreparationId]
    ON [dbo].[WebAgent_WireInPreparation_Branches_failing]([PreparationId] ASC, [DestCountry] ASC, [BrState] ASC, [BrCity] ASC, [AgPayerCode] ASC);
