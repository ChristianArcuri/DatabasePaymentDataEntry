CREATE PROCEDURE [dbo].[WebAgent_UserPaymentMethodInfo_Save_Gateway_WhiteLabel]
  ...
  IF @SenderPaymentMethodId = 2 --ACH
     BEGIN
	   ...
	   OR (rtrim(@AccountType) NOT IN( 'S','C'))
        ...
        EXEC WireSearch.dbo.GIACT_ValidateAccountNumber_WhiteLabel @WebAgentUserId ,@PreparationId, @CurrentWebLanguageId ,
