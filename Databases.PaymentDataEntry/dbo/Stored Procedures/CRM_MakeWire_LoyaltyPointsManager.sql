CREATE PROCEDURE [dbo].[CRM_MakeWire_LoyaltyPointsManager]
 ...
 BEGIN TRY 
  ...
  ELSE -- Redemption
     BEGIN
			...
			UPDATE SqlMain.WireTransac.dbo.CRM_SameSenders 
			   SET PointsBalance = PointsBalance - @PointsToRedeem, LastRedemptionDate = @Today
