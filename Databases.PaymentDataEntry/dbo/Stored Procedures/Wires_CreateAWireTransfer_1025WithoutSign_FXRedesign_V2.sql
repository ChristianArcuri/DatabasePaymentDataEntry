CREATE  PROCEDURE [dbo].[Wires_CreateAWireTransfer_1025WithoutSign_FXRedesign_V2]
(
    --Senders
	@SenderId int,
	@SenderGroupId int,
...
--------------------------------------------------------------------------------------------------------------------
 ...
 --insert TEST(Msg, NUM) values('@SenderPaymentMethodId', @SenderPaymentMethodId) 
...
---  insert into TEST(Msg) values('Wires_CreateAWireTransferToken')
...
*/
  ...
  BEGIN CATCH
   ...
   Set @ErrorMessage = @WireInfoForLog + ' ' + IsNull(@ErrorMessage, '')
	...
	INSERT INTO dbo.ErrorLog (ProcessName, ErrorMsg) values('Wires_CreateAWireTransfer_1025WithoutSign_FXRedesign', @ErrorMessage)
  END CATCH  
END TRY
BEGIN CATCH
    Set @ErrorSavingWire = 1
