CREATE procedure [dbo].[ImxDirect_WIRE_ChangeOfBeneficiary_Replacement_OldJun23_2020]
(	
...
as  
	...
	BEGIN TRY 
	 ...
	 -- BEGIN TRAN
	   ...
	   IF @Electronic1025 =1 AND @IdSelected = 1
		...
		BEGIN
					EXEC WireSearch.[dbo].[ImxDirect_WIRE_GetCharges_v5]
		...
		BEGIN
					...
					EXEC PaymentDataEntry.dbo.ImxDirect_WireInPreparation_Insert 
	...
	BEGIN CATCH
		...
		SET @LogErrorMessage  =  'ImxDirect_WIRE_ChangeOfBeneficiary_Replacement '+' - '+ @LogErrorMessage +' - '+ ERROR_MESSAGE()
